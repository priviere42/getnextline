...
gcc -Wall -Wextra -Werror -I ../includes -c ../get_next_line_utils.c

gcc -Wall -Wextra -Werror -I ../includes -c ../get_next_line.c
gcc -Wall -Wextra -Werror -I ../includes -I ".." -c main.c
gcc -Wall -Werror -Wextra -O3 -o test_gnl get_next_line.o main.o -L ../ -lft -I ".."
if [ ! -f test_gnl ]; then
